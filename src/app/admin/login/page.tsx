...
export default async function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-appbg px-6">
      <div className="w-full max-w-md rounded-2xl hairline bg-surface p-8 shadow-card">
